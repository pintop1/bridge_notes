...
@section('title', __('Paid Investments'))

@section('trans', __('active'))
@section('trans-paid', __('active'))
...
<div class="section-header-breadcrumb">
	...
	<div class="breadcrumb-item active"><a href="#">Paid Investments</a></div>
</div>
@endsection
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="d-inline-block">Paid Investments</h4>
			</div>
			<div class="card-body">
