...
@section('title', __('Declined Investments'))

@section('invests', __('active'))
@section('invests-dec', __('active'))
...
<div class="section-header-breadcrumb">
	...
	<div class="breadcrumb-item active"><a href="#">Declined Investments</a></div>
</div>
@endsection
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="d-inline-block">Declined Investments</h4>
			</div>
			<div class="card-body">
