...
@section('title', __('Active Investments'))

@section('invests', __('active'))
@section('invests-active', __('active'))
...
<div class="section-header-breadcrumb">
	...
	<div class="breadcrumb-item active"><a href="#">Active Investments</a></div>
</div>
@endsection
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="d-inline-block">Active Investments</h4>
			</div>
			<div class="card-body">
