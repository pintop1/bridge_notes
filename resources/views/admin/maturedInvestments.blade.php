...
@section('title', __('Matured Investments'))

@section('invests', __('active'))
@section('invests-matured', __('active'))
...
<div class="section-header-breadcrumb">
	...
	<div class="breadcrumb-item active"><a href="#">Matured Investments</a></div>
</div>
@endsection
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="d-inline-block">Matured Investments</h4>
			</div>
			<div class="card-body">
